...
public class Controller implements Initializable {
    ...
    int other2; // Second Opponent of Current Player
    ...
    public void initPlayers() {
        ...
        Player player1 = new Player("Yeohan");
        Player player2 = new Player("Jacob");
        Player player3 = new Player("Rinzai");
        players.add(player1);
        players.add(player2);
        players.add(player3);
    ...
    @FXML public ImageView playerThree; // Image of Player Three
    ...
    @FXML void posX(int i) {
        switch (board.getPlayers().get(curr).getPlayerOrder()) {
            ...
            case 2:
                ...
                break;
            case 3:
                playerThree.relocate(playerThree.getLayoutX() + 38.13, playerThree.getLayoutY());
                break;
        }
    } // move Right
    @FXML void posY(int i) {
        switch (board.getPlayers().get(curr).getPlayerOrder()) {
            ...
            case 2:
                ...
                break;
            case 3:
                playerThree.relocate(playerThree.getLayoutX(), playerThree.getLayoutY() - 36.10);
                break;
        }
    } // move Up
    ...
    @FXML public void update() {
        ...
        playerThreeMoney.setText(Integer.toString(board.getPlayers().get(2).getMoney()));
        ...
        playerThreeDebt.setText(Integer.toString(board.getPlayers().get(2).getBankLoan()));
        ...
        playerThreeMarried.setText(Boolean.toString(board.getPlayers().get(2).isMarried()));
        ...
        playerThreeDegree.setText(Boolean.toString(board.getPlayers().get(2).getCareerDegree()));
        ...
        playerThreeMinRaise.setText(Integer.toString(board.getPlayers().get(2).getMinRaise()));
        ...
        playerThreeMaxRaise.setText(Integer.toString(board.getPlayers().get(2).getPayRaise()));
        ...
        playerThreeSalary.setText(Integer.toString(board.getPlayers().get(2).getSalary()));
        ...
        playerThreeTaxDue.setText(Integer.toString(board.getPlayers().get(2).getTaxDue()));
    }
    ...
    public void initialize() {
        ...
        playerThreeName.setText(board.getPlayers().get(2).getName());
    ...
    @FXML private TextField playerThreeName;
    @FXML public TextField playerThreeMoney;
    @FXML private TextField playerThreeDebt;
    @FXML private TextField playerThreeMarried;
    @FXML private TextField playerThreeChildren;
    @FXML private TextField playerThreeHouse;
    @FXML private TextField playerThreeCareer;
    @FXML private TextField playerThreeMinRaise;
    @FXML private TextField playerThreeMaxRaise;
    @FXML private TextField playerThreeSalary;
    @FXML private TextField playerThreeTaxDue;
    @FXML private TextField playerOneDegree;
    @FXML private TextField playerTwoDegree;
    @FXML private TextField playerThreeDegree;
    ...
    public void move(int j) throws IOException {
        ...
        if (!(board.getPlayers().get(curr).getRetired()))
            for (i = 0; i < j; i++)
            {
                ...
                if (board.getPlayers().get(curr).getMoves() == 16 && board.getPlayers().get(curr).getPathTaken().equals("career")) {
                    ...
                    board.getCollegeRoad().getFullPath().get(17).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                    j = k;
                    printTextToPrompt("STOP!\n");
                    ...
                    printTextToPrompt("Player " + (board.getPlayers().get(curr).getPlayerOrder()) + " reached a Magenta Space");
                    posY(board.getPlayers().get(curr).getPlayerOrder());
                    board.getChangeCareerRoad().getFullPath().get(9).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                    j = k;
                    printTextToPrompt("STOP!\n");
                }
                    ...
                    printTextToPrompt("Player " + (board.getPlayers().get(curr).getPlayerOrder()) + " reached a Magenta Space");
                    negX(board.getPlayers().get(curr).getPlayerOrder());
                    board.getNormalRoadTwo().getFullPath().get(9).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                    j = k;
                    printTextToPrompt("STOP!\n");
                }
                ...
                if (board.getPlayers().get(curr).getCurrentMovesForPath() == (j)) {
                    if (board.getPlayers().get(curr).getPathTaken().equals("college")) {
                        if (board.getPlayers().get(curr).getCurrentMovesForPath() != 7 || board.getPlayers().get(curr).getCurrentMovesForPath() != 16 && board.getPlayers().get(curr).getCurrentMovesForPath() < 19) {
                            ...
                            board.getCollegeRoad().getFullPath().get(board.getPlayers().get(curr).getCurrentMovesForPath()).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                        ...
                        if (board.getPlayers().get(curr).getCurrentMovesForPath() != 16 && board.getPlayers().get(curr).getCurrentMovesForPath() < 19 ) {
                            printTextToPrompt("Player " + players.get(curr).getPlayerOrder() + "lands on Orange Space.\nThey pick an action card from the deck\n");
                            board.getCareerRoad().getFullPath().get(board.getPlayers().get(curr).getCurrentMovesForPath()).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                            printTextToPrompt("Card is " + players.get(curr).getActionCard().getName() + "\nspecifically " + players.get(curr).getActionCard().getEventDescript() + "\n");
                        }
                        ...
                        switch (p) {
                            ...
                            case 1, 2, 5, 7, 9, 10, 13, 16, 17, 19 : board.getChangeCareerRoad().getFullPath().get(p).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank()); printTextToPrompt("Player " + players.get(curr).getPlayerOrder() + "lands on Orange Space.\nThey pick an action card from the deck\n"); break;
                            case 3 : board.getChangeCareerRoad().getFullPath().get(2).triggerEvent(board.getPlayers(), board.getBlueDeck(), curr, other1, other2, board.getBank()); printTextToPrompt("Player " + players.get(curr).getPlayerOrder() + "lands on Blue Space.\nThey pick a blue  card from the deck\n");
                        ...
                        {
                            board.getNormalRoad().getFullPath().get(board.getPlayers().get(curr).getCurrentMovesForPath()).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                        ...
                        {
                            board.getNormalRoadTwo().getFullPath().get(board.getPlayers().get(curr).getCurrentMovesForPath()).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                            System.out.println("Path Taken: "  + board.getPlayers().get(curr).getPathTaken() + " " + board.getNormalRoadTwo().getFullPath().get(board.getPlayers().get(curr).getCurrentMovesForPath()).getEventName());
                                ...
                                switch(p)
                                {
                                    case 12: board.getFamilyRoad().getFullPath().get(11).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                                    case 15: board.getFamilyRoad().getFullPath().get(14).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                                    case 22: board.getFamilyRoad().getFullPath().get(21).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                                    case 26: board.getFamilyRoad().getFullPath().get(25).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                                    default: board.getFamilyRoad().getFullPath().get(p).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                                }
                        ...
                        if (board.getPlayers().get(curr).getMoves() == 118)
                        {
                            ...
                            board.getLastRoad().getFullPath().get(board.getPlayers().get(curr).getCurrentMovesForPath()).triggerEvent(board.getPlayers(), board.getActionDeck(), curr, other1, other2, board.getBank());
                            System.out.println("Path Taken: "  + board.getPlayers().get(curr).getPathTaken() + " " + board.getLastRoad().getFullPath().get(board.getPlayers().get(curr).getCurrentMovesForPath()).getEventName());
                        }
                    }
                        update();
    ...
    {
        if (board.getPlayers().get(0).getRetired() && board.getPlayers().get(1).getRetired() && board.getPlayers().get(2).getRetired()) {
            if (board.getPlayers().get(0).getMoney() > board.getPlayers().get(1).getMoney())
            {
                if (board.getPlayers().get(2).getMoney() > board.getPlayers().get(0).getMoney())
                    printTextToPrompt("Player " + board.getPlayers().get(2).getPlayerOrder() + "WINS THE GAME");
                else
                    printTextToPrompt("Player " + board.getPlayers().get(0).getPlayerOrder() + "WINS THE GAME");
            }
            else if (board.getPlayers().get(2).getMoney() > board.getPlayers().get(1).getMoney())
                printTextToPrompt("Player " + board.getPlayers().get(2).getPlayerOrder() + "WINS THE GAME");
            else
